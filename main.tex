...
\subtitle{\includegraphics[width=4cm]{images/logo_transparent.png}\\Common Lines Implied Clustering}
\author{Donovan Webb}
...
\begin{frame}[fragile]{Pipeline}
  \begin{center}\includegraphics[width=1\textwidth]{images/first_pipeline.png}
    \end{center}
  
    \pause
    \placetextbox[north west]{0}{0.63}{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.5pt}\includegraphics[width=0.7\textwidth]{images/no_dimred.png}}
...
\begin{frame}[fragile]{Dimensional Reduction}
  ...
  \textbf{Linear} (PCA) \\
  \includegraphics[width=0.3\textwidth]{images/dimredcomps/PCA_sins.png}

  \textbf{Non-Linear}  \\
\begin{tabular}{cc}
  \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/LLE_sins.png}} 
  & \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/ISOMAP_sins.png}} \\
  \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/TSNE_sins.png}}
  & \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/UMAP_sins.png}} \\
\end{tabular} \\
a: LLE, b: ISOMAP, c: TSNE, d: UMAP
  \end{center}
\end{frame}

\setcounter{eqn}{0}
\begin{frame}[fragile]{Dimensional Reduction - ground truths}
  \vspace{-1em}\begin{center}
  \textbf{Find features - Reduce noise} \\
  % Swiss roll explanation? !XXXX
  % Dimensional reduction can be used to lower influence of noise and try to find common features of data.
  ...
  % and non-linear Iso map or lle !XXXX
  \textbf{Linear} (PCA) \\
  \includegraphics[width=0.3\textwidth]{images/dimredcomps/PCA_gt.png}

  \textbf{Non-Linear}  \\
\begin{tabular}{cc}
  \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/LLE_gt.png}} 
  & \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/ISOMAP_gt.png}} \\
  \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/TSNE_gt.png}}
  & \num\putindeepbox[7pt]{\includegraphics[width=0.3\textwidth]{images/dimredcomps/UMAP_gt.png}} \\
\end{tabular} \\
a: LLE, b: ISOMAP, c: TSNE, d: UMAP
  \end{center}
\end{frame}
...
\begin{frame}[fragile]{Pipeline}
  \begin{center}\includegraphics[width=1\textwidth]{images/third_pipeline.png}
    \end{center}
  %\placetextbox[north west]{0.17}{0.63}{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.5pt}\includegraphics[width=0.4\textwidth]{images/tree.png}}
