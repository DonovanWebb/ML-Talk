...
\begin{frame}[fragile]{Dimensional Reduction - Linear (PCA)}
  ...
  \begin{center}
  \only<1>{\hspace{0.35em}\includegraphics[width=0.7\textwidth]{images/pcavsmani/PCA2D.png}}
  \only<2>{\includegraphics[width=0.7\textwidth]{images/pcavsmani/PCA2D1comp.png}}
  \only<3>{\includegraphics[width=0.7\textwidth]{images/pcavsmani/PCA2D2comp.png}}
  \end{center}
\end{frame}
...
\begin{frame}[fragile]{Linear vs Non-Linear - Swiss Roll} 
	...
	\begin{center}
		  ...
		  \fbox{\begin{minipage}[t][0.4\textheight][t]{0.45\textwidth}
                    \begin{center}
                    \only<1>{\includegraphics[width=0.65\textwidth]{images/pcavsmani/swiss_PCA_2_crop.png} \\}
                    \only<2,3>{\includegraphics[width=0.65\textwidth]{images/pcavsmani/swiss_PCA_2_crop_arrow.png} \\}
                    \only<1>{PCA \\
		  ...
		  \fbox{\begin{minipage}[t][0.40\textheight][t]{0.45\textwidth}
                    \begin{center}
                    \only<1,2>{\includegraphics[width=0.65\textwidth]{images/pcavsmani/swiss_UMAP_2_crop.png}\\}
                    \only<3>{\includegraphics[width=0.65\textwidth]{images/pcavsmani/swiss_UMAP_2_crop_arrow.png}\\}
                    \only<1,2>{UMAP \\
...
\begin{frame}[fragile]{Dimensional Reduction - Linear}
  ...
  \end{center}
 \placetextbox[north west]{0.04}{0.62}{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.5pt}\includegraphics[width=0.25\textwidth]{images/figures/no_e.png}}
 \placetextbox[north west]{0.75}{0.62}{\setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.5pt}\includegraphics[width=0.25\textwidth]{images/figures/all_edit.png}}
  }
\end{frame}
